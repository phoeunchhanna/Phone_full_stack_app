                ...
                <div class="row align-items-center">
                    <div class="col-sm-12">
                        <div class="page-sub-header">
                            <h3 class="page-title">កែប្រែការអនុញ្ញាត</h3>
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ route('home') }}">ទំព័រដើម</a></li>
                                <li class="breadcrumb-item"><a href="{{ route('brands.index') }}">ការអនុញ្ញាត</a></li>
                                <li class="breadcrumb-item active">កែប្រែការអនុញ្ញាត</li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card comman-shadow">
                        <div class="card-body">
                            <form action="{{ route('permissions.update', $permission->id)}}" method="POST" enctype="multipart/form-data" id="formcreate">
                                @csrf
                                <div class="Row">
                                    <div class="form-group d-flex align-items-center justify-content-between">
                                        <h3 class="text-primary font-weight-600 mb-0">កែប្រែការអនុញ្ញាត</h3>
                                        <span>
                                            <!-- Back Button -->
                                    ...
                                    <div class="form-group">
                                        <label for="name">ឈ្មោះការអនុញ្ញាត<span class="login-danger">*</span></label>
