        ...
        <div class="row">
            <div class="col-md-3">
                <div class="card">
                    ...
                    <div class="alert alert-info d-none">
                        ...
                        First Product Category: {{ $products->first() ? $products->first()->category_id : 'N/A' }}
                    </div>
                    <div class="card-body">
                        <ul class="list-unstyled">
                            @foreach ($categories as $categoryItem)
                                <li class="mb-2">
                                    <a href="{{ route('category.products', $categoryItem->id) }}"
                                        class="text-decoration-none {{ $categoryItem->id == $category->id ? 'fw-bold text-primary' : '' }}">
                                        {{ $categoryItem->name }}
                                    </a>
                                </li>
                            @endforeach
            ...
            <div class="col-md-9">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h3 class="mb-0">Products in Category: {{ $category->name }}</h3>
