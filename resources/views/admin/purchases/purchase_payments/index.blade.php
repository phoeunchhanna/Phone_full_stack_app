                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="page-sub-header">
                            <h3 class="page-title">ការទូទាត់ការបញ្ជាទិញ</h3>
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ route('home') }}">ទំព័រដើម</a></li>
                                <li class="breadcrumb-item active">បញ្ជីការទូទាត់ការបញ្ជាទិញ</li>
                            </ul>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card-body">
                            <div class="page-header">
                                <div class="row align-items-center">
                                    <div class="col">
                                        <h3 class="page-title">បញ្ជីការទូទាត់ការបញ្ជាទិញ</h3>
                                    </div>
                                </div>
                                    ...
                                    <tbody>
                                        @foreach ($payments as $payment)
                                            <tr>
                                                ...
                                                <td>
                                                    @can('កែប្រែការទូទាត់ការបញ្ជាទិញ')
                                                    <a href="{{ route('purchase_payments.edit', ['purchase_id' => $payment->purchase_id, 'purchase_payment' => $payment->id]) }}"
                                                        class="btn btn-secondary btn-sm">
                                                        <i class="bi bi-pencil-square"></i>
                                                     </a>
                                                    @endcan

                                                     @can('លុបការទូទាត់ការបញ្ជាទិញ')
                                                     <form id="deleteForm{{ $payment->id }}"
                                                        action="{{ route('purchase_payments.destroy', $payment->id) }}"
