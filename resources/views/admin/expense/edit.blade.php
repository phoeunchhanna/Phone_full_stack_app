                    ...
                    <div class="col-sm-12">
                        <div class="page-sub-header">
                            ...
                            <ul class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">កែប្រែការចំណាយ</li>
                            </ul>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card-body">
                            <form action="{{ route('expenses.update', $expense->id) }}" method="POST">
                                ...
                                <div class="form-group d-flex align-items-center justify-content-between">
                                    <h3 class="text-primary font-weight-600 mb-0">កែប្រែការចំណាយ</h3>
                                    <span>
                                        <!-- Back Button -->
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" name="date" id="date" class="form-control" value="{{ old('date', $expense->date) }}">
                                                    @error('date')
                                                        <small class="text-danger">{{ $message }}</small>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="col-12 col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="reference" id="reference" class="form-control" value="{{ old('reference', $expense->reference) }}">
                                                    @error('reference')
                                                        <small class="text-danger">{{ $message }}</small>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="col-12 col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="amount" id="amount" class="form-control" value="{{ old('amount', $expense->amount) }}" placeholder="$" step="0.01" min="0">
                                                    @error('amount')
                                                        <small class="text-danger">{{ $message }}</small>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="col-12 col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="details" id="details" rows="4" class="form-control">{{ old('details', $expense->details) }}</textarea>
                                                    @error('details')
                                                        <small class="text-danger">{{ $message }}</small>
                                                    @enderror
                                                </div>
