                            ...
                            <div class="col-12">
                                <div class="invoice-info d-flex justify-content-between align-items-center">
                                    <div class="invoice-head">
                                        <h2 class="text-primary">បង្កើតការបង្វិលចូលទំនិញ</h2>
                                    </div>
                                    <span>
                                ...
                                <div class="row">
                                    <div class="col-lg-4 col-md-12">
                                        <div class="invoice-info invoice-info-one border-1">
                                            <h4 class=" text-light">លេខយោង(លេខវិក័យបត្រ) : {{ $sale->reference }}</h4>
                                            <h4 class=" text-light">កាលបរិច្ឆេទទិញទំនិញ : {{ \Carbon\Carbon::parse($sale->date)->translatedFormat('d/m/Y') }}</h4>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-md-12">
                                        <div class="invoice-info invoice-info-one border-0">
                                            <h4 class=" text-light" name="customer_name">ឈ្មោះអតិថិជន:
                                                {{ $sale->customer ? $sale->customer->name : 'មិនមានព័ត៌មានអតិថិជន' }}</h4>
                                            <h4 class=" text-light">លេខទូរស័ព្ទ : {{ $sale->customer->phone }}</h4>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-md-12">
                                        <div class="invoice-info invoice-info-one border-0">
                                            <h4 class=" text-light" name="customer_name">ចំនួនទឹកប្រាក់ដែលបានជំពាក់:
                                                $ {{ $sale->due_amount ? $sale->due_amount : 'N/A' }}</h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-8 col-md-6">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="paid_amount">ចំនួនទឹកប្រាក់បង់ជូនអតិថិជន</label>
                                                        <input type="number" name="paid_amount" placeholder="$ វាបញ្ចូលទឹកប្រាក់ដែលប្រគល់ជូនអតិថិជន"
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        `);
                            ...
                            $(".total_price").text(formatCurrency(0));
                            $("#display_grandTotal").text(formatCurrency(0));
