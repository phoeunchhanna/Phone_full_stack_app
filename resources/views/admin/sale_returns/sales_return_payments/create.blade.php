        ...
        <div class="content container-fluid">
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        <h3 class="page-title">បង្កើតការប្រគល់វិក័យបត្រ</h3>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('sale_returns.index') }}">ការប្រគល់វិក័យបត្រ</a></li>
                            <li class="breadcrumb-item active">បង្កើតការប្រគល់វិក័យបត្រ</li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-body">
                            <div class="col-12">
                                <div class="col-12">
                                    <h5 class="form-title student-info">បង្កើតការទូទាត់ការប្រគល់វិក័យបត្រ
                            ...
                            <form action="{{ route('sale_return_payments.store') }}" method="POST">
                                ...
                                <div class="form-group">
                                    <label for="sale_return_id">យោងការប្រគល់វិក័យបត្រ</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="due_amount" id="due_amount" class="form-control" step="0.01" value="{{ ($saleReturn->due_amount) }}" required readonly >
                                </div>
                                <div class="form-group">
                                ...
                                <input type="hidden" value="{{ $saleReturn->id }}" name="sale_return_id">
