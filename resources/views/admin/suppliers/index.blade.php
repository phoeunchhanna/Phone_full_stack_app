                    ...
                    <div class="col-sm-12">
                        <div class="page-sub-header">
                            <ul class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">បញ្ជីរាយនាមអ្នកផ្គត់ផ្គង់</li>
                            </ul>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card-body">
                            <div class="page-header">
                                <div class="row align-items-center">
                                    <div class="col mb-2">
                                        <h3 class="text-primary font-weight-600">បញ្ជីអ្នកផ្គត់ផ្គង់</h3>
                                        <div class="col-auto text-end float-end ms-auto download-grp">
                                            @can('បង្កើតអ្នកផ្គត់ផ្គង់')
                                            <a href="{{ route('suppliers.create') }}" class="btn btn-primary">បន្ថែម <i
                                        ...
                                        <tbody>
                                            @foreach ($suppliers as $supplier)
                                                <tr>
                                                    ...
                                                    <td class="text-end">
                                                        @can('កែប្រែអ្នកផ្គត់ផ្គង់')
                                                        <a href="{{ route('suppliers.edit', $supplier->id) }}"
                                                            class="btn btn-secondary btn-sm"><i
                                                                class="bi bi-pencil-square"></i></a>
                                                        @endcan

                                                         @can('លុបអ្នកផ្គត់ផ្គង់')
