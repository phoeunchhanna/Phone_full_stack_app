                ...
                <div class="row align-items-center">
                    <div class="col">
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('sale-returns.index') }}">បញ្ជីការបង្វែរចូលទំនិញ</a></li>
                            <li class="breadcrumb-item active">កែប្រែការបង្វែរចូលទំនិញ</li>
                        </ul>
                    </div>
                </div>
            </div>
                            ...
                            <div class="col-12">
                                <div class="invoice-info d-flex justify-content-between align-items-center">
                                    <div class="invoice-head">
                                        <h2 class="text-primary">កែប្រែការបង្វែរចូលទំនិញ</h2>
                                    </div>
                                    <span>
