                    ...
                    <div class="col-sm-12">
                        <div class="page-sub-header">
                            <ul class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">បញ្ជីអតិថិជន</li>
                            </ul>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card-body">
                            <div class="page-header">
                                <div class="row align-items-center">
                                    <div class="col mb-2">
                                        <h3 class="text-primary font-weight-600">បញ្ជីអតិថិជន</h3>
                                        <div class="col-auto text-end float-end ms-auto download-grp">
                                            @can('បង្កើតអតិថិជន')
                                            <a href="{{ route('customers.create') }}" class="btn btn-primary">បន្ថែម <i
                                        ...
                                        <tbody>
                                            @foreach ($customers as $customer)
                                                <tr>
                                                    ...
                                                    <td class="text-end">
                                                        @can('កែប្រែអតិថិជន')
                                                        <a href="{{ route('customers.edit', $customer) }}" type="button"
