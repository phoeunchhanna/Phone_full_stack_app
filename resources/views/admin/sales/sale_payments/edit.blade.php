        ...
        <div class="content container-fluid">
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        <h3 class="page-title">កែរប្រែការទូទាត់ការលក់</h3>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('sales.index') }}">ការលក់</a></li>
                            <li class="breadcrumb-item active">កែរប្រែការទូទាត់ការលក់</li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-body">
                            <div class="col-12">
                                <div class="col-12">
                                    <h5 class="form-title student-info">កែរប្រែការទូទាត់ការលក់
                                        <span>
                                ...
                                <div class="row">
                                    <div class="col-lg-4 col-md-6">
                                        <div class="form-group">
                                            <label for="sale_id">លេខយោង</label>
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="due_amount" id="due_amount" class="form-control" step="0.01"
                                                   value="{{ $sale->due_amount }}" required readonly>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="date" id="date" class="form-control"
                                                   value="{{ old('date', $salePayment->date) }}" required>
                                            @error('date')
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="amount" id="amount" class="form-control" step="0.01"
                                                   value="{{ old('amount', $salePayment->amount) }}" required>
                                            @error('amount')
                                                <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="payment_method" class="form-control form-select" required>
                                                <option value="សាច់ប្រាក់" {{ old('payment_method', $salePayment->payment_method) == 'សាច់ប្រាក់' ? 'selected' : '' }}>
                                                    សាច់ប្រាក់
                                                </option>
                                                <option value="អេស៊ីលីដា" {{ old('payment_method', $salePayment->payment_method) == 'អេស៊ីលីដា' ? 'selected' : '' }}>
                                                    អេស៊ីលីដា
                                                </option>
                                                <option value="ABA" {{ old('payment_method', $salePayment->payment_method) == 'ABA' ? 'selected' : '' }}>
                                                    ABA
                                                </option>
                                            </select>
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <textarea name="note" id="note" class="form-control">{{ old('note', $salePayment->note) }}</textarea>
                                            @error('note')
                                                <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
