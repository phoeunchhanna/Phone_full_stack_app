                ...
                <div class="row align-items-center">
                    <div class="col-sm-12">
                        <div class="page-sub-header">
                            <h3 class="page-title">បង្កើតប្រភេទផលិតផល</h3>
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ route('home') }}">ទំព័រដើម</a></li>
                                <li class="breadcrumb-item"><a href="{{ route('brands.index') }}">ប្រភេទផលិតផល</a></li>
                                <li class="breadcrumb-item active">បង្កើតប្រភេទផលិតផល</li>
                            </ul>
                        </div>
                    </div>
                </div>
